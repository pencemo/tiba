    ...
    <div className='bg-neutral-900'>
      {/* <!-- Testimonials with Stats --> */}
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center lg:justify-between">
            ...
            {/* <!-- Title --> */}
            <div className="mb-8">
                <h2 className="mb-2 text-3xl font-bold lg:text-4xl text-neutral-200">
            ...
            <blockquote className="relative">
                ...
                <div className="flex items-center">
                    ...
                    <div className="font-semibold  text-neutral-200">Josh Grazioso</div>
                    <div className="text-xs  text-neutral-500">Director Payments & Risk | Airbnb</div>
                    </div>
                </div>
                </footer>
            </blockquote>
            ...
            <div className="space-y-6 sm:space-y-8">
                {/* <!-- List --> */}
                <ul className="grid grid-cols-2  divide-y-2  divide-x-2  overflow-hidden divide-neutral-700">
                <li className="flex flex-col -m-0.5 p-4 sm:p-8">
                    <div className="flex items-end gap-x-2 text-3xl sm:text-5xl font-bold  mb-2 text-neutral-200">
                    45k+
                    </div>
                ...
                <li className="flex flex-col -m-0.5 p-4 sm:p-8">
                    <div className="flex items-end gap-x-2 text-3xl sm:text-5xl font-bold  mb-2 text-neutral-200">
                    {/* <svg className="flex-shrink-0 size-5  text-blue-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m5 12 7-7 7 7"/><path d="M12 19V5"/></svg> */}
                    <ArrowUp size={20} strokeWidth={1.5} className="flex-shrink-0 size-5  text-blue-500" />
                    23%
                    </div>
                    <p className="text-sm sm:text-base text-neutral-400">
